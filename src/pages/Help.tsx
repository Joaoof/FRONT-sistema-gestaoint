                ...
                <div className="max-w-2xl">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-4 border border-gray-300 dark:border-white/15 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                    </div>
                </div>
            </div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <a
                                    ...
                                    className="text-gray-700 dark:text-slate-200 hover:text-blue-600 dark:text-blue-400 hover:underline"
                                >
