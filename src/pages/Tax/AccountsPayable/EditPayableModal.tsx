...
export function EditPayableModal({ payable, onClose, onSaved }: EditPayableModalProps) {
    ...
    // Campos que só aparecem quando o status vai pra PAID
    ...
    const wasAlreadyPaid = payable.status === 'PAID';
    ...
    // Default Itaú quando método requer (cartão/boleto), a menos que o usuário tenha escolhido manualmente.
    useEffect(() => {
