...
const VIEW_TO_MODULE: Record<View, string> = {
  ...
  'timeline/communications': 'timeline',
...
const sections: MenuSection[] = [
  {
    ...
    items: [
      ...
      {
        id: 'timeline' as View,
        label: 'Novidades do dia',
        icon: Sparkles,
        children: [
          { id: 'timeline' as View, label: 'Hub (todas)', icon: Sparkles },
          { id: 'timeline/financial' as View, label: 'Financeiro', icon: Wallet },
          { id: 'timeline/commercial' as View, label: 'Comercial', icon: ShoppingCart },
          { id: 'timeline/operational' as View, label: 'Operacional', icon: Truck },
          { id: 'timeline/communications' as View, label: 'Comunicações', icon: MessageCircle },
          { id: 'timeline/alerts' as View, label: 'Alertas', icon: AlertTriangle },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'financeiro/integracoes' as View, label: '🏦 Integrações Bancárias', icon: Banknote },
...
const groupedChildren: Record<string, View[]> = {
  ...
  financeiro: ['financeiro', 'bancos', 'financeiro/relatorios', 'financeiro/conciliacao', 'financeiro/integracoes', 'relatorios/visao-geral', 'boletos'],
