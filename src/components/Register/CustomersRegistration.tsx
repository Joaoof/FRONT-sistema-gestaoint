                            ...
                            {filteredClientes.map((cliente) => (
                                <tr key={cliente.id} className="hover:bg-gray-50 dark:hover:bg-slate-800">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <div className="text-sm text-gray-500 dark:text-slate-400">{cliente.documento}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                        ...
                                        <div className="text-gray-500 dark:text-slate-400">{cliente.telefone}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                        <div>{cliente.cidade}, {cliente.estado}</div>
                                        <div className="text-gray-500 dark:text-slate-400">{cliente.cep}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
