...
export const UpgradeModal: React.FC<UpgradeModalProps> = ({ isOpen, onClose, moduleName }) => {
    if (!isOpen) return null

    const handleWhatsAppClick = () => {
        const message = `Olá! Gostaria de fazer upgrade do meu plano para ter acesso ao módulo ${moduleName}. Meu email é: ${localStorage.getItem("user_email") || "não informado"}`
